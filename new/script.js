...
const e = txt.indexOf('\u0cc6')


while (e > -1) {
  if (txt[e - 4] === '\u0ccd' && txt[e - 2] === '\u0ccd') {
    const txt = txt.slice(0, e - 5) + 'e' + txt.slice(e - 5, e) + txt.slice(e + 1)
    const e = txt.indexOf('\u0cc6')
  } else if (txt[e - 2] === '\u0ccd') {
    const txt = txt.slice(0, e - 3) + 'e' + txt.slice(e - 3, e) + txt.slice(e + 1)
    const e = txt.indexOf('\u0cc6')
  } else {
    const txt = txt.slice(0, e - 1) + 'e' + txt[e - 1] + txt.slice(e + 1)
    const e = txt.indexOf('\u0cc6')
  }
}
const E = txt.indexOf('\u0cc7')
...
const g = txt.indexOf('\u0cca')

while (g > -1) {
  if (txt[g - 4] === '\u0ccd' && txt[g - 2] === '\u0ccd') {
    const txt = txt.slice(0, g - 5) + 'e' + txt.slice(g - 5, g) + 'a' + txt.slice(g + 1)
    const g = txt.indexOf('\u0cca')
  } else if (txt[g - 4] !== '\u0ccd' && txt[g - 2] === '\u0ccd') {
    const txt = txt.slice(0, g - 3) + 'e' + txt.slice(g - 3, g) + 'a' + txt.slice(g + 1)
    const g = txt.indexOf('\u0cca')
  } else {
    const txt = txt.slice(0, g - 1) + 'e' + txt.slice(g - 1, g) + 'a' + txt.slice(g + 1)
    const g = txt.indexOf('\u0cca')
  }
}
G = txt.indexOf('\u0ccb')
...
while (G > -1) {
  if (txt[G - 4] === '\u0ccd' && txt[G - 2] === '\u0ccd') {
    const txt = txt.slice(0, G - 5) + 'F' + txt.slice(G - 5, G) + 'a' + txt.slice(G + 1)
    const G = txt.indexOf('\u0ccb')
  } else if (txt[G - 4] !== '\u0ccd' && txt[G - 2] === '\u0ccd') {
    const txt = txt.slice(0, G - 3) + 'F' + txt.slice(G - 3, G) + 'a' + txt.slice(G + 1)
    const G = txt.indexOf('\u0ccb')
  } else {
    const txt = txt.slice(0, G - 1) + 'F' + txt.slice(G - 1, G) + 'a' + txt.slice(G + 1)
    const G = txt.indexOf('\u0ccb')
  }
}
H = txt.indexOf('\u0cb0\u0ccd')
...
while (H > -1 && txt[H + 1] !== ' ' && txt[H + 1] !== '\u200d' && txt[H + 1] !== '\u200c') {
  const txt = txt.slice(0, H) + txt[H + 2] + 'f' + txt.slice(H + 3)
  const H = txt.indexOf('\u0cb0\u0ccd')
}
